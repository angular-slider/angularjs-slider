...
.factory('RzSlider', ['$timeout', '$document', '$window', 'throttle', function ($timeout, $document, $window, throttle) {
    ...
    Slider.prototype = {
        ...
        init: function () {
            ...
            unRegFn = this.scope.$watch('rzSliderPresentOnly', function (newValue, oldValue) {
                if (newValue === oldValue) { return; }
                self.updatePresentOnlyState();
            });
            this.deRegFuncs.push(unRegFn);
        ...
        /**
         * Update PresentOnly State 
         *
         * @returns {undefined}
         */
        updatePresentOnlyState: function () {
            var calcDimFn = angular.bind(this, this.calcViewDimensions);

            if (this.scope.rzSliderPresentOnly) {
                this.sliderElem.attr('disabled', true);
                this.minH.off();
                this.maxH.off();
                angular.element($window).off('resize', calcDimFn);
                this.unbindEvents();
                ...
                this.sliderElem.attr('disabled', false);
                this.minH.on();
                this.maxH.on();
                angular.element($window).on('resize', calcDimFn);
                this.bindEvents();
        ...
        unbindEvents: function () {
            this.minH.off('mousedown', angular.bind(this, this.offStart, this.minH, 'rzSliderModel'));
            if (this.range) { this.maxH.off('mousedown', angular.bind(this, this.offStart, this.maxH, 'rzSliderHigh')); }
            this.fullBar.off('mousedown', angular.bind(this, this.offStart, this.minH, 'rzSliderModel'));
            this.fullBar.off('mousedown', angular.bind(this, this.offMove, this.fullBar));
            this.selBar.off('mousedown', angular.bind(this, this.offStart, this.minH, 'rzSliderModel'));
            this.selBar.off('mousedown', angular.bind(this, this.offMove, this.selBar));

            this.minH.off('touchstart', angular.bind(this, this.offStart, this.minH, 'rzSliderModel'));
            if (this.range) { this.maxH.off('touchstart', angular.bind(this, this.offStart, this.maxH, 'rzSliderHigh')); }
            this.fullBar.off('touchstart', angular.bind(this, this.offStart, this.minH, 'rzSliderModel'));
            this.fullBar.off('touchstart', angular.bind(this, this.offMove, this.fullBar));
            this.selBar.off('touchstart', angular.bind(this, this.offStart, this.minH, 'rzSliderModel'));
            this.selBar.off('touchstart', angular.bind(this, this.offMove, this.selBar));
        },
        /**
...
.directive('rzslider', ['RzSlider', function (Slider) {
    ...
    return {
        ...
        scope: {
            ...
            rzSliderPresentOnly: '=?',
            ngDisabled: '=? rzSliderPresentOnly'
        },

...
<a target='_blank' rel='nofollow' href='https://app.codesponsor.io/link/CMeGmKFDEwosBVenFgaJ511r/angular-slider/angularjs-slider'>
  <img alt='Sponsor' width='888' height='68' src='https://app.codesponsor.io/embed/CMeGmKFDEwosBVenFgaJ511r/angular-slider/angularjs-slider.svg' />
</a>
...
**restrictedRange** - _Object (defaults to null)_: Has two _Number_ properties, _from_ and _to_ that determine the bounds of an area that is not authorized for values
